...
declare module "$app/types" {
	...
	export interface AppTypes {
		RouteId(): "/(page)" | "/(menulist)" | "/" | "/(page)/CMS-CON-001" | "/(page)/CMS-LOC-001" | "/(page)/CMS-LOC-001/reg" | "/(page)/CMS-LOC-001/[...id]/detail" | "/(page)/CMS-LOC-001/[...id]/edit" | "/(page)/CMS-LOC-001/[...id]" | "/(page)/CMS-MAP-001" | "/(page)/CMS-MAP-002" | "/(page)/CMS-MAP-003" | "/(page)/CMS-MAP-004" | "/(page)/CMS-OBD-001" | "/(page)/CMS-OBD-002" | "/(page)/CMS-STA-001" | "/(page)/CMS-STA-002" | "/(page)/CMS-UI" | "/api" | "/api/cms-loc-001" | "/api/menu" | "/(menulist)/menulist";
		RouteParams(): {
			"/(page)/CMS-LOC-001/[...id]/detail": { id: string };
			"/(page)/CMS-LOC-001/[...id]/edit": { id: string };
			"/(page)/CMS-LOC-001/[...id]": { id: string }
		};
		LayoutParams(): {
			...
			"/(page)/CMS-LOC-001": { id?: string | undefined };
			"/(page)/CMS-LOC-001/reg": Record<string, never>;
			"/(page)/CMS-LOC-001/[...id]/detail": { id: string };
			"/(page)/CMS-LOC-001/[...id]/edit": { id: string };
			"/(page)/CMS-LOC-001/[...id]": { id: string };
		...
		Pathname(): "/" | "/CMS-CON-001" | "/CMS-LOC-001" | "/CMS-LOC-001/reg" | `/CMS-LOC-001/${string}/detail` & {} | `/CMS-LOC-001/${string}/edit` & {} | "/CMS-MAP-001" | "/CMS-MAP-002" | "/CMS-MAP-003" | "/CMS-MAP-004" | "/CMS-OBD-001" | "/CMS-OBD-002" | "/CMS-STA-001" | "/CMS-STA-002" | "/CMS-UI" | "/api/cms-loc-001" | "/api/menu" | "/menulist";

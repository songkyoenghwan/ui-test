...
declare module '$env/static/private' {
	export const ZEROBREW_PREFIX: string;
	export const TERM_PROGRAM: string;
	export const NODE: string;
	export const ZEROBREW_BIN: string;
	...
	export const ZEROBREW_ROOT: string;
	...
	export const ZEROBREW_DIR: string;

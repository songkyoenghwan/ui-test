<main class="sub">
	...
	<nav class="slide-left max-w-full overflow-x-auto">
		<ul class=" flex snap-center items-center gap-5 scroll-smooth">
			...
			<li>
				<a href="" class="tab-link">Company</a>
			</li>
			<li>
				<a href="" class="tab-link">AR.ON</a>
			</li>
			<li>
				<a href="" class="tab-link">News</a>
			</li>
			<li>
				<a href="" class="tab-link">Press</a>
			</li>
			<li>
				<a href="" class="tab-link">Spatial Crafter</a>
			</li>
			<li>
				<a href="" class="tab-link">XR Showroom</a>
			</li>
		</ul>
	</nav>

<main class="sub">
	...
	<section class="text-2md grid gap-5 rounded-xl bg-white p-5 transition-all lg:gap-15 lg:p-15">
		...
		<ol class="flex flex-col gap-5 lg:gap-7.5">
			<li data-scroll="slide-up" class="grid items-center gap-5 rounded-xl bg-white lg:grid-cols-[minmax(0,1fr)_322px] lg:flex-row lg:gap-15">
				...
				<picture class="border-d9d9d9 col-span-2 grid h-53.5 place-content-center overflow-clip rounded-xl border transition-all lg:col-span-1 lg:h-60">

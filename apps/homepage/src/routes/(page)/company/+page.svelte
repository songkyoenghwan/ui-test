<main class="sub">
	<sub-heading-line title="Company" text="The people and structure driving DEEP.FINE’s innovation"></sub-heading-line>
	...
	<section data-scroll="slide-up" class="text-2md grid gap-5 rounded-xl bg-white p-5 drop-shadow-md transition-all [animation-timeline:view()] lg:gap-15 lg:p-15">
		...
		<ol class="flex flex-col gap-5 lg:gap-7.5">
			<li data-scroll="slide-up" class="grid items-center gap-5 rounded-xl bg-white lg:grid-cols-[minmax(0,1fr)_322px] xl:flex-row xl:gap-50">
				<header
					class="bg-primary items col-span-2 mb-0 flex h-30 flex-col justify-center gap-1.5 overflow-clip rounded-xl bg-cover bg-center bg-no-repeat p-5 text-white lg:mb-10 lg:h-45 lg:gap-2.5 lg:px-15 lg:py-5"
				>
					<p class="text-2md lg:text-2xl">2023~2024</p>
					<p class="text-lg font-bold lg:text-2xl">Leap &amp; Growth</p>
				</header>
				<!-- 이부분은 추가 할떄마다 추가  -->

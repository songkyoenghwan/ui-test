class FooterTag extends HTMLElement {
	...
	render() {
		this.rendered = true;
		this.innerHTML = /* HTML */ `
			<footer class="footer text-2md text-666 lg:pb-7.5 pb-5 lg:text-lg" data-scroll="slide-up">
				<div class="relative rounded-xl bg-white lg:grid lg:grid-cols-2">
					<footer-adress class="lg:p-7.5 flex flex-col gap-5 p-5"></footer-adress>

					<section class="lg:p-7.5 flex flex-col justify-between gap-15 p-5 lg:gap-5">
						...
						<footer-sns class="gap-7.5 inline-flex w-full items-center justify-center lg:justify-end"></footer-sns>
					</section>
